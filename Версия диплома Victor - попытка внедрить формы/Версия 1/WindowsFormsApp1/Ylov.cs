...
namespace WindowsFormsApp1
{
    public partial class Hamsa : Form
    {
        public void ins(ArrayList lines, ArrayList orig) // эт для вставки 
        {
            ...
            {
                уловыTableAdapter.Update(Convert.ToString(lines[0]),
                                         ...
                                         Convert.ToString(orig[0]),
                                         Convert.ToString(orig[1]),
                                         Convert.ToInt16(orig[2]),
                                         Convert.ToInt16(orig[3]),
                                         Convert.ToInt16(orig[4]),
                                         Convert.ToString(orig[5]),
                                         Convert.ToString(orig[6]),
                                         Convert.ToString(orig[7]),
                                         Convert.ToString(orig[8]),
                                         Convert.ToString(orig[9]),
                                         Convert.ToDouble(orig[10]),
                                         Convert.ToDouble(orig[11]),
                                         Convert.ToString(orig[12]),
                                         Convert.ToString(orig[13]),
                                         Convert.ToDouble(orig[14]),
                                         Convert.ToDateTime(orig[15]),
                                         Convert.ToString(orig[16]),
                                         Convert.ToString(orig[17]),
                                         Convert.ToString(orig[18]),
                                         Convert.ToDouble(orig[19]),
                                         Convert.ToDouble(orig[20]),
                                         Convert.ToDouble(orig[21]),
                                         Convert.ToDouble(orig[22]),
                                         Convert.ToDouble(orig[23]),
                                         Convert.ToDouble(orig[24]),
                                         Convert.ToDouble(orig[25]),
                                         Convert.ToDouble(orig[26]),
                                         Convert.ToDouble(orig[27]),
                                         Convert.ToDouble(orig[28]),
                                         Convert.ToString(orig[29]),
                                         Convert.ToString(orig[30]),
                                         Convert.ToDouble(orig[31]),
                                         Convert.ToString(orig[32]),
                                         Convert.ToString(orig[33]),
                                         Convert.ToString(orig[34])
                                         );
                уловыTableAdapter.Update(this.тестовая_бд_DataSet);
            }
